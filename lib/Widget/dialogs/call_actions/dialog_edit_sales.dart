...
class DialogEditSales extends StatefulWidget {
  final SaleModel sale;
  final Function getData;
  final String from;
  const DialogEditSales({super.key, required this.sale, required this.getData, required this.from});

  @override
  State<DialogEditSales> createState() => _DialogEditSalesState();
}

class _DialogEditSalesState extends State<DialogEditSales> {
  ...
  _getCustomers(){
    ...
    _sale = _sale.where((element) => element.eid == widget.sale.eid).toList();
  ...
  void initState() {
    ...
    super.initState();
    _getCustomers();
    amount = double.parse(widget.sale.amount.toString());
    _pay.text = widget.sale.paid.toString();
    method = widget.sale.method.toString();
                            ...
                            onTap: ()async{
                              ...
                              if(isValidform){
                                if(cName!="" || _name.text.toString() != ""){
                                  ...
                                  await Data().editSales(
                                    context,
                                    widget.getData,
                                    widget.sale.saleid,
                                    _pay.text.toString(),
                                    widget.sale.amount.toString(),
                                    method.toString(),
