...
class DialogPayPrchItem extends StatefulWidget {
  final double amount;
  final Function updatePayable;
  const DialogPayPrchItem({super.key, required this.amount, required this.updatePayable});

  @override
  State<DialogPayPrchItem> createState() => _DialogPayPrchItemState();
}

class _DialogPayPrchItemState extends State<DialogPayPrchItem> {
      ...
      child: Column(
        ...
        children: [
          ...
          DoubleCallAction(action: (){
            widget.updatePayable(double.parse(_pay.text), type);
